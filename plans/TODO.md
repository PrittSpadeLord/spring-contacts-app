1. Fix podman postgresql connection issues
...
10. When it's time to create UI endpoints, make sure `/register` returns a 201 (Resource created) instead of 200.
11. Experiment with Open J Proxy